#' myBoot2
#'
#' @param iter The amount of iterations of sampling
#' @param x The data set to draw samples from
#' @param fun The function to apply to the samples
#' @param alpha Confidence interval alpha
#' @param cx symbol scale
#' @param ... any additional parameters
#'
#' @returns A histogram of the sample distributions given the function
#' @export
#'
#' @examples myboot2(x=c(1:100))
myboot2<-function(iter=10000,x,fun="mean",alpha=0.05,cx=1.5,...){  #Notice where the ... is repeated in the code
  ...
  list(xstat = xstat, cil = ci[1], ciu = ci[2])
}
